...
var SaveDate = middyfy(savedata);
var deleteVal = async (event) => {
  let ID = event.body.ID;
  console.log(ID, "eee");
  const user = await dynamo_default.delete(ID, "WahabTable").catch((err) => {
